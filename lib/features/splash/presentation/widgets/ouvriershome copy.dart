...
import 'package:bhyapp/features/splash/presentation/widgets/ouvrier_prime%20copy.dart';
import 'package:bhyapp/ouvrier/ouvrier_name.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class HabataHome extends StatefulWidget {
  final UserLocal? user;
  const HabataHome({super.key,required this.user});

  @override
  State<HabataHome> createState() => _HabataHomeState();
}

class _HabataHomeState extends State<HabataHome> {
  bool _isLoading = true;
  final TextEditingController _nomdeouvrier = TextEditingController();
  TextEditingController get controller => _nomdeouvrier;
  final TextEditingController _lieuvente = TextEditingController();
  TextEditingController get controller2 => _lieuvente;
  ...
  void initState() {
    ...
    db.collection("habata").get().then((qsnap) {
      setState(() {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              String hintText = "Ajouter un vendeur";
              showEditDialog(context, hintText, controller, controller2);
            },
          ),
        ],
      ),
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                    ...
                    labelText: "chercher un vendeur (${displayList.length})",
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) => ListTile(
                    ...
                    subtitle: Text(
                      'Lieu de vente : ${displayList[index].lieu}',
                      style: TextStyle(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Habatadetails2(
  ...
  Future<void> deleteOuvrier(String ouvrierId) async {
    try {
      final db = FirebaseFirestore.instance;
      final ouvrierRef = db.collection('habata').doc(ouvrierId);
                ...
                onPressed: () {
                  ...
                  if (newName.isNotEmpty) {
                    setState(() {
                      if (newName.isNotEmpty) {
                        final db = FirebaseFirestore.instance;
                        final ouvrier = db.collection("habata");
